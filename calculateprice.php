            ...
            <div class="col">
                    <h5 class="pb-2">Aantal nachten en personen</h5>
                        <div class="input-group mb-3">
                            ...
                            <input type="number" min="0" class="form-control" name="numberNights" id="numberNights" placeholder="Aantal nachten" aria-label="Aantal nachten" value="<?php echo $numberNights; ?>">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Aantal volwassenen</span>
                            <input type="number" min="0" class="form-control" name="numberAdults" id="numberAdults" placeholder="Aantal volwassenen" aria-label="Aantal volwassenen" value="<?php echo $numberAdults; ?>">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Aantal kinderen</span>
                            <input type="number" min="0" class="form-control" name="numberChilds" id="numberChilds" placeholder="Aantal kinderen" aria-label="Aantal kinderen" value="<?php echo $numberChilds; ?>">
                        </div>
            </div>
            <div class="col">
                    ...
                    <?php
                        ...
                        <div class="row">
                          <div class="col-9">
                            ...
                            <div class="col-3">
                                <input type="number" min="0" class="form-control" id="AmountAdd_<?php echo $addition["addition_id"]; ?>" name="AmountAdd_<?php echo $addition["addition_id"]; ?>" value="<?php echo $AmountAdd[$addition["addition_name"]];?>">
                            </div>
                        </div>
                    <?php } //end foreach ?>
